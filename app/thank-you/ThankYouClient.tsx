...
export default function ThankYouClient() {
  ...
  useEffect(() => {
    clear()
    console.log('Cart cleared on thank you page')
  }, [clear])
      ...
      <div className="max-w-2xl mx-auto text-center px-6">
        ...
        >
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-serif font-bold text-brand-maroon mb-4">
              Thank You for Your Order!
            </h1>
            <p className="text-lg text-gray-600 mb-4">
              Your order has been received successfully and is being prepared.
            </p>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-600">
              <div className="flex flex-col items-center">
                <Package className="w-8 h-8 text-brand-maroon mb-2" />
                <span>Order Processing</span>
              </div>
              <div className="flex flex-col items-center">
                <ShoppingBag className="w-8 h-8 text-brand-maroon mb-2" />
          ...
          >
            ...
            >
              <Link href={`/receipt?order_id=${orderId}&session_id=${searchParams.get('session_id') || ''}`}>
